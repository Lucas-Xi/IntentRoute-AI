...
- The UI is Chinese-first: only the Settings page follows the language preference with English static text; all other pages and dynamic messages remain Chinese.
