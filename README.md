...
- The UI is Chinese-first: all static XAML text plus dynamic display values (rule rows, count badges, severities, verdicts) follow the language preference with English. Status messages, dialogs, and runtime-error text remain Chinese.
