...
- The UI is Chinese-first: every window-layer string and the AI-provider error/validator/diagnostic texts follow the language preference with English. AppService messages, remaining runtime-error text, and Policy Intelligence finding titles remain Chinese.
