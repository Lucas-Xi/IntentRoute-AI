...
- The UI is Chinese-first: all static XAML text, dynamic display values, and AI-page status messages follow the language preference with English. Rules/settings dialogs, runtime-error text, and AppService/runtime messages remain Chinese.
