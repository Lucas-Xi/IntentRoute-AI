...
- The UI is Chinese-first: the window frame, navigation, Settings, and About pages follow the language preference with English text; rule/policy/simulator/monitor/process page bodies and all dynamic messages remain Chinese.
