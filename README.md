...
- The UI is Chinese-first: every window-layer string — statics, dynamic display values, status messages, and dialogs — follows the language preference with English. AppService messages, runtime-error text, and Policy Intelligence finding titles remain Chinese.
